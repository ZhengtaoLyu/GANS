...
parser.add_argument('--input_folder', default='../data/Meow_64x64', help='input folder')
parser.add_argument('--output_folder', default='../res/DCGAN', help='output folder')
...
parser.add_argument('--n_workers', type=int, default=0, help='Number of subprocess to use to load the data. Use at least 2 or the number of cpu cores - 1.')
...
# For plotting the Loss of D and G usin
