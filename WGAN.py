...
parser.add_argument('--output_folder', default='../res/WGAN', help='output folder')
...
parser.add_argument('--n_workers', type=int, default=0, help='Number of subprocess to use to load the data. Use at least two or the number of cpu cores - 1.')
